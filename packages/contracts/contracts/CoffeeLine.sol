...
contract CoffeeLine is ICoffeeLine {
  ...
  function createProducer(ProducerParams calldata _params) external override(ICoffeeLine) returns(Producer memory producer) {
  ...
  function createBean(BeanParams calldata _params) external override(ICoffeeLine) returns(IBean bean) {

  }

  function createRoaster(RoasterParams calldata _params) external override(ICoffeeLine) returns(Roaster memory roaster) {
